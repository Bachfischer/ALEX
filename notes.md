...
`ssh -i .ssh/google_compute_engine bachfischer@34.121.226.243`
...
Query benchmark:
`./build/benchmark -r 1 ./data/books_200M_uint32 ./data/books_200M_uint32_equality_lookups_10M --pareto --csv --only ALEX`
`./build/benchmark -r 1 ./data/books_200M_uint32 ./data/books_200M_uint32_equality_lookups_10M --pareto --csv --only PGM`
`./build/benchmark -r 1 ./data/books_200M_uint32 ./data/books_200M_uint32_equality_lookups_10M --pareto --csv --only BTree`


Insertion benchmark:
`./build/benchmark -r 1 ./data/books_200M_uint32 ./data/books_200M_uint32_equality_lookups_1M --inserts ./data/books_200M_uint32_inserts_1M --pareto --only ALEX`
